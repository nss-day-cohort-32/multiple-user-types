...
namespace MultipleUserTypesApp.Controllers
{
    public class UserTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserTypeId,Title")] UserType userType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserTypeId,Title")] UserType userType)
        {
